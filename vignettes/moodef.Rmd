...
We can define the questions one by one using a definition function or in bulk using a data frame or a csv file. Below we show the possibilities offered.
